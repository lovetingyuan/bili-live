/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31ae4962119da723559ae007c5f77778)
// Runtime types generated with workerd@1.20260630.1 2025-05-14 
interface __BaseEnv_Env {
	KV_BILI_LIVE: KVNamespace;
	WX_PUSHER_USER_ID: string;
	WX_PUSHER_APP_TOKEN: string;
	WX_PUSHER_APPID: string;
	NPOINT_ID: string;
	SAFE_TOKEN: string;
	BILI_UPS: string;
	FT_SEND_KEY: string;
	VERCEL_PROXY_SAFE_TOKEN: string;
